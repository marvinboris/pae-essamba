                        ...
                        <div class="tab-content" id="en_v-pills-tabContent">
                            ...
                            <div class="tab-pane fade" id="en_v-pills-paragraphs" role="tabpanel" aria-labelledby="en_v-pills-paragraphs-tab">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="pae-events+evaluation+paragraphs+{{ $key }}+title+en" id="en_paragraph_{{ $key }}_title" value="{{ $paragraph['title']['en'] }}" class="form-control">
                                    
                                    <label for="en_paragraph_{{ $key }}_content" class="control-label">Content</label>
                                    <textarea name="pae-events+evaluation+paragraphs+{{ $key }}+content+en" id="en_summernote_paragraph_{{ $key }}_content">{!! $content['paragraphs'][$key]['content']['en'] !!}</textarea>
                                </div> 
                                @endforeach
                            </div>
                            ...
                            <div class="tab-pane fade" id="en_v-pills-event" role="tabpanel" aria-labelledby="en_v-pills-event-tab">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="pae-events+evaluation+event+offers+{{ $key }}+slider_title+en" id="en_summernote_offer_{{ $key }}_slider_title">{!! $offer['slider_title']['en'] !!}</textarea>

                                    <label for="en_offer_{{ $key }}_title" class="control-label">Title</label>
                                    <input type="text" name="pae-events+evaluation+event+offers+{{ $key }}+title+en" id="en_offer_{{ $key }}_title" value="{{ $offer['title']['en'] }}" class="form-control">
                                    
                                    <label for="en_offer_{{ $key }}_content" class="control-label">Content</label>
                                    <textarea name="pae-events+evaluation+event+offers+{{ $key }}+content+en" id="en_summernote_offer_{{ $key }}_content">{!! $offer['content']['en'] !!}</textarea>
                                </div> 
                                @endforeach
                            </div>
                        </div>
                        ...
                        <div class="tab-content" id="fr_v-pills-tabContent">
                            ...
                            <div class="tab-pane fade" id="fr_v-pills-paragraphs" role="tabpanel" aria-labelledby="fr_v-pills-paragraphs-tab">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="pae-events+evaluation+paragraphs+{{ $key }}+title+fr" id="fr_paragraph_{{ $key }}_title" value="{{ $paragraph['title']['fr'] }}" class="form-control">
                                    
                                    <label for="fr_paragraph_{{ $key }}_content" class="control-label">Content</label>
                                    <textarea name="pae-events+evaluation+paragraphs+{{ $key }}+content+fr" id="fr_summernote_paragraph_{{ $key }}_content">{!! $content['paragraphs'][$key]['content']['fr'] !!}</textarea>
                                </div> 
                                @endforeach
                            </div>
                            ...
                            <div class="tab-pane fade" id="fr_v-pills-event" role="tabpanel" aria-labelledby="fr_v-pills-event-tab">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="pae-events+evaluation+event+offers+{{ $key }}+slider_title+fr" id="fr_summernote_offer_{{ $key }}_slider_title">{!! $offer['slider_title']['fr'] !!}</textarea>

                                    <label for="fr_offer_{{ $key }}_title" class="control-label">Title</label>
                                    <input type="text" name="pae-events+evaluation+event+offers+{{ $key }}+title+fr" id="fr_offer_{{ $key }}_title" value="{{ $offer['title']['fr'] }}" class="form-control">
                                    
                                    <label for="fr_offer_{{ $key }}_content" class="control-label">Content</label>
                                    <textarea name="pae-events+evaluation+event+offers+{{ $key }}+content+fr" id="fr_summernote_offer_{{ $key }}_content">{!! $offer['content']['fr'] !!}</textarea>
                                </div> 
                                @endforeach
                            </div>
                        </div>
