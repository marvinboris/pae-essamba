        ...
        <div class="tab-content bg-white rounded-bottom rounded-right text-dark p-3" id="nav-tabContent">
            <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                <div class="form-group">
                    ...
                    <input type="text" name="posts+annual-procedure+title+en" id="en_title" value="{{ $content['title']['en'] }}" class="form-control">
                </div>
                <div class="form-group">
                    <label for="en_content" class="control-label h5">Content</label>
                    <textarea name="posts+annual-procedure+content+en" id="en_summernote_content">{!! $content['content']['en'] !!}</textarea>
                </div>
                {{-- <div class="form-group">
            ...
            <div class="tab-pane fade" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab">
                <div class="form-group">
                    ...
                    <input type="text" name="posts+annual-procedure+title+fr" id="fr_title" value="{{ $content['title']['fr'] }}" class="form-control">
                </div>
                <div class="form-group">
                    <label for="fr_content" class="control-label h5">Content</label>
                    <textarea name="posts+annual-procedure+content+fr" id="fr_summernote_content">{!! $content['content']['fr'] !!}</textarea>
                </div>
                {{-- <div class="form-group">
