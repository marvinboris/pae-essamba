...
@section('content')
    ...
    <div class="simple-slider">
        <div class="swiper-container">
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide" style="{{ "background-image:url('/assets/images/" . $slider['img_url'] . "');" }}">
    ...
    <div class="container" style="padding-top: 30px;">
        <div class="row">
            <div class="col-md-8">
                <div class="col-md-12">
                    <h3 class="breadcrumbs"><i class="fa fa-map" aria-hidden="true"></i>&nbsp;{!! $content['activities']['title'][session('lang')] !!}</h3>
                    <p>
                        {!! $content['activities']['content'][session('lang')] !!} <br> <br>
                    </p>
                </div>
                <div class="col-md-12" style="padding-top: 1%;">
                    <div id="myCarousel" class="carousel slide" data-ride="carousel">
                        ...
                        <ol class="carousel-indicators">
                            ...
                            <li data-target="#myCarousel" data-slide-to="{{ +$key-1 }}" {{ +$key === 1 ? "class=\"active\"" : "" }}></li>    
                            @endforeach
                        </ol>
                        <!-- Wrapper for slides -->
                        <div class="carousel-inner">
                            ...
                            <div class="item {{ +$key === 1 ? "active" : "" }}">
                                <img src="/assets/images/{{ $slider['img_url'] }}" alt="Los Angeles">
                            </div>
                            @endforeach
                        </div>
    ...
    <div class="container" style="padding-top: 30px;padding-bottom: 35px;">
        <div class="row">
            <div class="col-md-12">
                <h3 class="breadcrumbs"><i class="fa fa-newspaper-o" aria-hidden="true"></i>&nbsp;{{ $content['news']['title'][session('lang')] }}</h3>
                <p>{!! $content['news']['content'][session('lang')] !!} <br> <br>
                </p>
    ...
    <div class="container-fluid know-us">
        <div class="container">
            <div class="row">
                <h3>&nbsp;{!! $content['contact']['title'][session('lang')] !!}</h3>
            </div>
            <div class="row">
    ...
    <div class="container-fluid" style="background-color: #00000012;">
        <div class="container" style="padding-top: 30px;padding-bottom: 35px;">
            <div class="row">
                <div class="col-md-12">
                    <h3 class="breadcrumbs"><i class="fa fa-user" aria-hidden="true"></i>&nbsp;{!! $content['team']['title'][session('lang')] !!}</h3>
                    <p style="font-size: 18px;">{!! $content['team']['content'][session('lang')] !!}</p>
                </div>
            </div>
            <div class="row">
                <div class="col-md-3">
                    ...
                    <div style="border: 1px solid #74737396;">
                        <div class="btn-pref btn-group btn-group-justified btn-group-lg" role="group" aria-label="...">
                            ...
                            <div class="btn-group" role="group">
                                <button type="button" class="btn {{ +$key === 1 ? "project-active" : "" }} btn-white" href="#tab{{ $key }}"
                                    data-toggle="tab">
                                    <div class="hidden-xs">{!! $event['slider_title'][session('lang')] !!}</div>
                                </button>
                            </div>    
                            @endforeach
                        </div>
    ...
    <div class="container-fluid" style="background-color: #00000012;">
        <div class="container" style="padding-top: 30px;padding-bottom: 35px;">
            <div class="row">
                <div class="col-md-12">
                    <h3 class="breadcrumbs"><i class="fa fa-user" aria-hidden="true"></i>&nbsp;{!! $content['partners']['title'][session('lang')] !!}</h3>
                    <p style="font-size: 18px;">{!! $content['partners']['content'][session('lang')] !!}</p>
                </div>
            </div>
            <div class="row">
